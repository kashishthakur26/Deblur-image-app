...
from src.cnn.utils.common import load_images, write_log
from src.cnn.components.losses import wasserstein_loss, perceptual_loss
from src.cnn.components.model import generator_model, discriminator_model, generator_containing_discriminator_multiple_outputs
...
def train_command(n_images, batch_size, log_dir, epoch_num, critic_updates):
    return train_multiple_outputs(100, 16, True, 4, 5)
